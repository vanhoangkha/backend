...
from utils.athena import get_table_info, format_query_result
...
def sql_inference():
    ...
    table_info = get_table_info(athena_client, data_information)
    ...
    try:
        ...
        query_execution = athena_client.start_query_execution(
            ...
            ResultConfiguration={
                'OutputLocation': 's3://830843313441-us-west-2-athena-results-bucket/tan/'
            },
